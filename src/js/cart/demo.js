/* ============================================================================
   ...
   успел поменять:
     ...
     ?demo=boxes    коробки с разным весом (src/data/boxes.js): лосось нежно
                    подвяленный × 2 (202 и 204 г — ближайшие к номиналу)
                    и осётр × 1 в наличии, клыкач — коробка под заказ,
                    и обычная позиция в наличии. Итог «≈ 11 871,20 ₽» —
                    приблизительный только из-за клыкача; «Выбрать другие»
                    у лосося и осетра открывает окно выбора.
