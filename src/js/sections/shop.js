 ...
 * нет: витрина — короткая подсказка, а не выдача каталога. Про сердца
 * решение подтверждено 17.09.2026 вместе с появлением избранного: сердце
 * есть в сетке раздела, на карточке товара, в её лентах, на обзоре кабинета
 * и на /favorites, а на витрине главной его нет.
 */
/**
